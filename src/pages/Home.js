    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: BACKGROUND_COLOR }]}>
             ...
             <TouchableOpacity
                  ...
                  activeOpacity={0.7}
                  >
                    <Text style={styles.startButtonText}>Go To User Profile</Text>
             </TouchableOpacity>
             <TouchableOpacity
                  style={styles.startButton}
                  ...
                  activeOpacity={0.7}
                  >
                     <Text style={styles.startButtonText}>View Targets</Text>
             </TouchableOpacity>
             <TouchableOpacity
                  style={styles.startButton}
                  ...
                  activeOpacity={0.7}
                  >
                     <Text style={styles.startButtonText}>Select your plan</Text>
                  </TouchableOpacity>
        </SafeAreaView>
    )
}
